...
class DetalhaAlbumControllerTest extends SpringBootIntegrationTest {
    ...
    public void naoDeveDetalharAlbumComSuasFigurinhas_quandoAlbumNaoEncontrado() throws Exception {
        ...
        // ação e validação
        mockMvc.perform(GET("/api/albuns/{id}", -9999).with(jwt()
                        .authorities(new SimpleGrantedAuthority("SCOPE_albuns:read"))
                ))
    ...
    @Test
    public void naoDeveDetalharAlbumComSuasFigurinhasQuandoAccessTokenNaoEnviado() throws Exception {
        // cenario
        Album album = new Album("DBZ", "Album do DBZ", "rafael.ponte");
        album.adiciona(
                new Figurinha("goku", "http://animes.com/dbz/goku.jpg"),
    ...
    @Test
    public void naoDeveDetalharAlbumComSuasFigurinhasQuandoAccessTokenNaoPossuiScopeApropriado() throws Exception {
        // cenario
        Album album = new Album("DBZ", "Album do DBZ", "rafael.ponte");
        album.adiciona(
                new Figurinha("goku", "http://animes.com/dbz/goku.jpg"),
