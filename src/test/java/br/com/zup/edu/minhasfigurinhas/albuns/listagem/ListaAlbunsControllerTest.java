...
class ListaAlbunsControllerTest extends SpringBootIntegrationTest {
    ...
    public void deveListarTodosOsAlbuns() throws Exception {
        ...
        // ação e validação
        mockMvc.perform(GET("/api/albuns").with(jwt()
    ...
    @Test
    public void naoDeveListarTodosOsAlbunsQuandoAccessTokenNaoEnviado() throws Exception {
        // cenário
        List.of(
                new Album("DBZ", "Album do DBZ", "rafael.ponte"),
                new Album("CDZ", "Album do CDZ", "jordi.silva"),
    ...
    @Test
    public void naoDeveListarTodosOsAlbunsQuandoAccessTokenNaoPossuiScopeApropriado() throws Exception {
        // cenário
        List.of(
                new Album("DBZ", "Album do DBZ", "rafael.ponte"),
                new Album("CDZ", "Album do CDZ", "jordi.silva"),
